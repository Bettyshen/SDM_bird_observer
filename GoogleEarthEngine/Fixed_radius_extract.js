//***************Goal********************//
// The goal of this script is to extract pixel value for all species via surveyor-centered approach for fixed radius extraction method

///////////////////////////////////////////////////////////////////////
///Section 1 - Load all Oregon data & Visualize on Map
///////////////////////////////////////////////////////////////////////
//==== Oregon 2020 zero-filled data (observer-location) ====//
...
var allYearsResultsComplete = allYearsResults.merge(allYearsResults2).merge(allYearsResults3).merge(allYearsResults4);
  ...
  description: 'Median_ObsCentered_100mfixedRadius',
